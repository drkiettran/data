...
yields <- read.csv("csv/fertyield.csv")
attach(yields)
head(yields)
table(treatment)
...
data <- read.csv("csv/weather.data.csv")
attach(data)
head(data)
